...
const colorsInitials = ["red", "orange", "yellow", "green", "blue", "violet"];
const [r, o, y, g, b, v] = colorsInitials;

const initial = ["indigo"];
const [indg] = initial;
...
const { song2, song4, characters: { kermit: { job: nestedJob, partner: nestedPartner }}} = obj;
